...
function useResponsiveValue(baseValue, mobileValue) {
  ...
  useEffect(() => {
    ...
    handle();
    let tid;
    const debounced = () => { clearTimeout(tid); tid = setTimeout(handle, 100); };
...
export const RadialScrollGallery = forwardRef((
  ...
  const buffer = childSize ? childSize.h * scaleFactor - childSize.h + 60 : 150;
              ...
              >
                <div
                  ...
                  className={[
                    ...
                    'focus-visible:ring-2 focus-visible:ring-[#fe2d2d] focus-visible:ring-offset-2',
